(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('proyectoRegistroAcademicoApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-proyectoRegistroAcademicoApp-error');
                var entityKey = httpResponse.headers('X-proyectoRegistroAcademicoApp-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('proyectoRegistroAcademicoApp.' + fieldError.objectName + '.' + convertedField);
